...
A buffer overflow vulnerability was discovered in the Edimax EW-7478AC firmware version ​**V1.04**. The vulnerability arises from the improper input validation of the `pptpUserName` parameter in the 'setWAN' interface of the file webs.
